...
public class Main {
  ...
  public static void welcomeMenu() {
    ...
    System.out.println("@@@@  Welcome to Rising BANK @@@@");
    while (end == false) {
      try {
  ...
  public static void LoginMenu(Account[] account, int accountCount, int btcRate) {
    boolean end = false;
    System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
    System.out.println("@@@@  Welcome to the Risings BANK @@@@");
    while (end == false) {
      try {
        System.out.println("\n Type 1 - Create Account");
  ...
  public static void withdraw(Account[] account, int accountId, int btcRate) {
    {
  ...
  public static void managerChangeRateBTC(Account[] account, int accountId, int btcRate) {
    Scanner inputAccountWithdraw = new Scanner(System.in);
